...
module.exports = {
  link: [
    ...
    { rel: "stylesheet", type: "text/css", href: "assets/libs/sweetalert/sweetalert.css" },

    /*{ rel: "stylesheet", type: "text/css", href: "assets/libs/primeui/themes/omega/theme.css" },
    { rel: "stylesheet", type: "text/css", href: "assets/libs/primeui/primeui-ng-all.min.css" }*/
  ],
  meta: [
