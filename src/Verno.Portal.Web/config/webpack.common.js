...
module.exports = function (options) {
  ...
  return {
    ...
    resolve: {
      ...
      modules: [helpers.root('src'), helpers.root('node_modules'), helpers.root('bower_modules')],
    ...
    resolveLoader: {
      ...
      new CopyWebpackPlugin([
                ...
                //{ from: 'bower_modules', to: 'assets/libs' },
                { from: 'bower_modules/jquery-validation/dist', to: 'assets/libs/jquery-validation' },
                { from: 'bower_modules/sweetalert/dist', to: 'assets/libs/sweetalert' },
                { from: 'bower_modules/jquery/dist', to: 'assets/libs/jquery' },
                { from: 'bower_modules/spin.js', to: 'assets/libs/spin.js' },
                { from: 'bower_modules/toastr', to: 'assets/libs/toastr' },
                { from: 'bower_modules/json2', to: 'assets/libs/json2' },
                { from: 'bower_modules/blockUI', to: 'assets/libs/blockUI' },
                ...
                {
                    from: 'node_modules/bootstrap-daterangepicker/daterangepicker.css',
                    to: 'assets/libs/bootstrap-daterangepicker/daterangepicker.css'
                }, {
          from: 'src/meta'
        } ]),
