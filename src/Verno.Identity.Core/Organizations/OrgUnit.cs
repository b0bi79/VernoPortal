...
namespace Verno.Identity.Organizations
{
    public class OrgUnit : Entity<int>
    {
        ...
        private static OrgUnitType ParseEnum(string value)
        {
            if (string.IsNullOrEmpty(value))
                return Organizations.OrgUnitType.Unknown;
            return (OrgUnitType)Enum.Parse(typeof(OrgUnitType), value, true);
        }
